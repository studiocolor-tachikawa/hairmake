      ...
      <header className="fixed top-0 left-0 right-0 z-50 bg-white border-b border-gray-200">
        <div className="max-w-6xl mx-auto px-4 h-16 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            <a
              href="https://www.instagram.com/color_hairmake?igsh=MW95M3A3andvc2dmMw=="
              target="_blank"
            ...
            <a
              href="https://www.tiktok.com/@colorhairmake?lang=ja-JP&is_from_webapp=1&sender_device=mobile&sender_web_id=7630717362127914504"
              target="_blank"
              rel="noopener noreferrer"
              className="text-gray-700 hover:text-black transition-colors"
            >
            ...
            <a
              href="https://m.youtube.com/channel/UC6kvajJ0GLdgQNSf_Og2GBQ?fbclid=PAb21jcARSoHVleHRuA2FlbQIxMQBzcnRjBmFwcF9pZA81NjcwNjczNDMzNTI0MjcAAae392e49LcBxmnSJHWf81KafR1rUWUA1VtNN6VmakmVUHfj9USMfusD4TJ45Q_aem_eZ7uZ39bh7FMHgPALtdX1g"
              target="_blank"
              rel="noopener noreferrer"
              className="text-gray-700 hover:text-black transition-colors"
            >
              <svg
                ...
                fill="currentColor"
              >
                <path d="M23.5 6.2a3.02 3.02 0 0 0-2.12-2.14C19.48 3.5 12 3.5 12 3.5s-7.48 0-9.38.56A3.02 3.02 0 0 0 .5 6.2 31.3 31.3 0 0 0 0 12a31.3 31.3 0 0 0 .5 5.8 3.02 3.02 0 0 0 2.12 2.14c1.9.56 9.38.56 9.38.56s7.48 0 9.38-.56a3.02 3.02 0 0 0 2.12-2.14A31.3 31.3 0 0 0 24 12a31.3 31.3 0 0 0-.5-5.8zM9.6 15.68V8.32L15.96 12 9.6 15.68z" />
              </svg>
            </a>
            <button
